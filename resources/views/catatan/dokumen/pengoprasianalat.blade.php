                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p class="statusMsg"></p>
                                    <form method="post" action="tambah_operasialat">
                                        <div class="card mb-4">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group row">
                                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Pelaksanaan Sesuai POB</label>
                                                    <div class="col-sm-10"> 
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10"> 
                                                        <input type="datetime-local" name="tanggal" class="form-control" id="inputEmail3" />
                                                    </div>
                                                </div>

                                                <div class="form-group row">
                                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Nama Alat</label>
                                                    <div class="col-sm-10"> 
                                                ...
                                                <div class="form-group row">
                                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Tipe/Merek</label>
                                                    <div class="col-sm-10"> 
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10"> 
                                                        <input type="text" name="ruang" class="form-control" id="inputEmail3" placeholder="Tipe/Merek" />
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card mb-4">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="inputEmail3" class="col-sm-2 col-form-label">Oleh</label>
                                                        <div class="col-sm-10"> 
