                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form>
                                    ...
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-2 col-form-label">Tanggal Pengambilan Contoh</label>
                                        <div class="col-sm-10">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form>
                                    ...
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-2 col-form-label">Jumlah Bahan Baku dalam Master Box</label>
                                        <div class="col-sm-10">
                                            <select class="form-control" id="inlineFormCustomSelect">
                                                <option selected>Choose...</option>
                                                <option value="1">Baik</option>
                                    ...
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-2 col-form-label">Jumlah Produk yang Diambil</label>
                                        <div class="col-sm-10">
                                            <select class="form-control" id="inlineFormCustomSelect">
                                                <option selected>Choose...</option>
                                                <option value="1">Baik</option>
                                    ...
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-2 col-form-label">Jenis dan Warna Kemasan</label>
                                        <div class="col-sm-10">
                                            <select class="form-control" id="inlineFormCustomSelect">
                                                <option selected>Choose...</option>
                                                <option value="1">Baik</option>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form>
                                    ...
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-2 col-form-label">Jumlah Produk Jadi dalam Master Box</label>
                                        <div class="col-sm-10">
                                            <select class="form-control" id="inlineFormCustomSelect">
                                                <option selected>Choose...</option>
                                                <option value="1">Baik</option>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form>
                                    ...
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-2 col-form-label">Jumlah Kemasan dalam Master Box</label>
                                        <div class="col-sm-10">
                                            <select class="form-control" id="inlineFormCustomSelect">
                                                <option selected>Choose...</option>
                                                <option value="1">Baik</option>
