                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="/input_komposisi" method="post" role="form">
                                            ...
                                            <input type="hidden" name="nobatch" value="{{ $row['nomor_batch'] }}" <div
                                                class="form-group">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="/input_penimbangan" method="post" role="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="jumlah_butuh" class="form-control" id="inputName"
                                            placeholder="Jumlah yang Dibutuhkan" />
                                    </div>
                                    <div class="form-group">
                                        <label for="inputEmail">Jumlah yang Ditimbang</label>
                                        <input type="text" name="jumlah_timbang" class="form-control" id="inputName"
                                            placeholder="Jumlah yang Ditimbang" />
                                    </div>
                                    <div class="form-group">
            ...
            <div class="card-header">
                ...
                <div class="dropdown float-right">
                    ...
                    <div class="dropdown-menu">
                        <li><a class="nav-link active bg-white text-dark" href="#tab-0" data-toggle="tab">Absolute
                                Reference</a></li>
